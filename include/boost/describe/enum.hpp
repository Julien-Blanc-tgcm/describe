...
#define BOOST_DESCRIBE_ENUM_ENTRY(E, e) , boost::describe::detail::boost_desc<E::e, []() noexcept { return #e; }> {}

#define BOOST_DESCRIBE_ENUM_END(E) )) { return {}; }
